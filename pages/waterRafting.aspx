<%@ Page Title="Water Rafting"  Language="C#" EnableEventValidation="false"  EnableSessionState="True" MasterPageFile="~/master/main.master" AutoEventWireup="true" CodeFile="waterRafting.aspx.cs" Inherits="pages_WaterRafting" %>
