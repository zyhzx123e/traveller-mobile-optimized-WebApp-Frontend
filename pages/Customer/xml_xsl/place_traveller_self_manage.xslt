		...
		<xsl:for-each select="//place">
		   <xsl:if test="./place_id = $place_id">
			    ...
			    <p class="p_detail" style="font-family: calibri;font-size:25px ;padding-bottom:10px;margin-bottom:10px"> <b>Title of Post: </b> 
					...
					<asp:FileUpload CssClass="btn-success" ClientIDMode="Static" style="width: 95%;padding: 10px;margin-left:5px;margin-right:20px;font-size: 15px;border-radius: 20px;border: 5px double;background-color: chocolate;opacity: .9;" ID="FileUpload1" runat="server" />  
