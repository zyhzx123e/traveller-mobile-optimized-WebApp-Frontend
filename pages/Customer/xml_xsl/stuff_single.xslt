  ...
  <xsl:template match="/">
		<xsl:for-each select="/stuffs/stuff">
		    <xsl:if test="./stuff_id = $stuff_id">
			    ...
			    <p class="p_detail">  
						<b>Description: </b> <xsl:value-of select="stuff_description" /> <br />
			    </p>
				<p class="p_detail">   
						<b>Address: </b> <xsl:value-of select="stuff_address" /> <br />
			    </p>
			    <p class="p_detail">   
						<b>Longitude: </b> <xsl:value-of select="stuff_longitude" /> <br />
			    </p>
				<p class="p_detail">  
						<b> Latitude: </b> <xsl:value-of select="stuff_latitude" /> <br />
				</p>
				<p class="p_detail">      
						<b> Time Uploaded: </b> <xsl:value-of select="stuff_time_upload" /> <br />
				</p>
				<p class="p_detail">      
					    <b>Shared by: </b> <span>
