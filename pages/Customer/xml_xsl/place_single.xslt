  ...
  <xsl:template match="/">
		<xsl:for-each select="/places/place">
		   <xsl:if test="./place_id = $place_id">
			   ...
			   <p class="p_detail">
					<b>Description: </b> <xsl:value-of select="place_description" /> <br/>
			   </p>
			   <p class="p_detail">
					<b>Address: </b><xsl:value-of select="place_address" /> <br />
			   </p>
			   <p class="p_detail">
					<b>Longitude: </b><xsl:value-of select="place_longitude" /> <br />
			   </p>
			   <p class="p_detail">  
