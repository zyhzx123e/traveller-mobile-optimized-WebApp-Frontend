...
public partial class pages_WaterSport : System.Web.UI.Page
{
...
//       The final string: 'Partly cloudy'
    ...
    public void bind_xsl_xml_data()
    {
        ...
        //load the data
        XPathDocument xdoc = new XPathDocument(Server.MapPath("~/pages/xml_xsl/waterSport.xml"));
        //load Xslt
        XslCompiledTransform transform = new XslCompiledTransform();
        transform.Load(Server.MapPath("~/pages/xml_xsl/waterSport.xslt"));
