...
public partial class traveller_admin_manage : System.Web.UI.Page
{
    ...
    public System.Web.UI.HtmlControls.HtmlInputText txt_item_name;
    ...
    public void bind_controls_in_xsl() {
        ...
        txt_item_name = (System.Web.UI.HtmlControls.HtmlInputText)ph_share_info.FindControl("txt_item_name");
...
public void sync_current_item_like_status() {
    ...
    public void populate_detail_share_info_from_xsl(string itemid)
    {
        ...
        if (itemid.Contains("place")) {
            ...
            transform.Load(Server.MapPath("~/pages/Customer/xml_xsl/place_traveller_admin_manage.xslt"));
            ...
            //load Xslt
            XslCompiledTransform transform = new XslCompiledTransform();
            transform.Load(Server.MapPath("~/pages/Customer/xml_xsl/stuff_traveller_admin_manage.xslt"));
            StringWriter sw = new StringWriter();
            //transform it
            transform.Transform(xdoc, xslArg, sw);
            string result = sw.ToString();
    ...
    protected void btn_save_click(object o,EventArgs e)
    {
        ...
        Session["txt_item_name"] = txt_item_name.Value.ToString();
   ...
   "https://res.cloudinary.com/demo/image/upload/v1375302801/tquyfignx5bxcbsupr6a.jpg"
        ...
        if (Session["selected_item_id"].ToString().Equals("place"))
        {
            //save placeinfo
          ...
          Session["txt_item_desc"] = txt_item_desc.Text.ToString();
            ...
            if (x_place_update!=null) {
               ...
               x_place_update.Element("place_name").Value = Session["txt_item_name"].ToString();
          ...
          Session["txt_item_desc"] = txt_item_desc.Text.ToString();
            ...
            if (x_stuff_update != null)
            {
                ...
                x_stuff_update.Element("stuff_name").Value = Session["txt_item_name"].ToString();
