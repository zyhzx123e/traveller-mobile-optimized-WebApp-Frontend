<%@ Page Title="Self Manage" Async="true"  Language="C#" EnableEventValidation="false" MasterPageFile="~/master/main.master" AutoEventWireup="true" CodeFile="traveller_admin_manage.aspx.cs" Inherits="traveller_admin_manage" %>
		 ...
		 <br />
          ...
          <b>Liked by </b>  <asp:Label ID="like_count_lbl" runat="server"></asp:Label> <b> Person(s)</b> <br />
             ...
             <div id="btn_section" style="    margin-top: 10px;">
                ...
                <asp:Button ID="admin_post_manage_btn_save" ClientIDMode="Static" OnClick="btn_save_click" Text="Commit Changes" CssClass="btn btn-primary" runat="server"   style="height:30px;width:100%;" />
            </div>
                  <div class="form-group center-block">
             
                        <asp:Button ID="admin_post_manage_btn_delete" ClientIDMode="Static" OnClick="btn_delete_click" Text="Delete Current Post" CssClass="btn btn-danger" runat="server"   style="height:30px;width:100%;" />
    ...
    <asp:Label ID="msg" runat="server"></asp:Label>
     ...
     <div runat="server" id="AlertBox" class="alertBox" Visible="false">
           ...
           <div runat="server" style="padding:5px;" id="div_pwd_verification">
               ...
               <asp:TextBox ID="txt_pwd_verification" TextMode="Password"  placeholder="Verify Your Password..." style="border:2px outset orange;border-radius:15px;margin:10px;padding:5px;width:95%;" runat="server"></asp:TextBox>
